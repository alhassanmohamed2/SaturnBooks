<?php 
  session_start(); 
	...
	function send_message( $form_data ) {
		...
		$to = "Saturn <saturnaassnd@gmail.com>";
		$from = "$name <$email>";
		...
		if( mail( $to, $subject, $message ) )  {
			echo '<p class="suc">Your message has been sent!</p>';
		}
	}
...
<div class="BC">
    <div class="box">
            <form name="contact" method="POST" class="cform">
					...
					<div class="dbtn">
                <input type="submit" name="submit" value="Send" class="btn" /> </div>
            </form>
    </div>
</div>
<?php 
